...
print_ascii_art() {
    ...
    printf "${NAVY_BLUE}   /SSSSSSS                               /SS                     /SS   /SS                      /SSSSSS  /SSSSSS    ${NC} \n"
    printf "${NAVY_BLUE}  | SS__  SS                             | SS                    |__/  | SS                     /SS__  SS|_  SS_/    ${NC} \n"
    printf "${NAVY_BLUE}  | SS  \ SS /SSSSSS   /SSSSSS   /SSSSSS | SS  /SSSSSS  /SS   /SS /SS /SSSSSS   /SS   /SS      | SS  \ SS  | SS      ${NC} \n"
    printf "${NAVY_BLUE}  | SSSSSSS//SS__  SS /SS__  SS /SS__  SS| SS /SS__  SS|  SS /SS/| SS|_  SS_/  | SS  | SS      | SSSSSSSS  | SS      ${NC} \n"
    printf "${NAVY_BLUE}  | SS____/| SSSSSSSS| SS  \__/| SS  \ SS| SS| SSSSSSSS \  SSSS/ | SS  | SS    | SS  | SS      | SS__  SS  | SS      ${NC} \n"
    printf "${NAVY_BLUE}  | SS     | SS_____/| SS      | SS  | SS| SS| SS_____/  >SS  SS | SS  | SS /SS| SS  | SS      | SS  | SS  | SS      ${NC} \n"
    printf "${NAVY_BLUE}  | SS     |  SSSSSSS| SS      | SSSSSSS/| SS|  SSSSSSS /SS/\  SS| SS  |  SSSS/|  SSSSSSS      | SS  | SS /SSSSSS    ${NC} \n"
    printf "${NAVY_BLUE}  |__/      \_______/|__/      | SS____/ |__/ \_______/|__/  \__/|__/   \___/   \____  SS      |__/  |__/|______/    ${NC} \n"
