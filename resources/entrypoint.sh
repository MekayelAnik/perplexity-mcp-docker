...
readonly HAPROXY_SERVER_NAME="perplexity"
...
start_mcp_server() {
    local mcp_server_cmd="npx -y @perplexity-ai/mcp-server"
    ...
    echo "Launching Perplexity MCP with protocol: ${PROTOCOL_DISPLAY}"
